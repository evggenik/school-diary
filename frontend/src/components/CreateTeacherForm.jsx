...
import { ru } from 'date-fns/locale'; // Импортируйте нужную локаль
...
// setDefaultLocale('ru'); // Устанавливаем локаль по умолчанию

// Определяем максимальный размер файла в байтах (например, 2 МБ)
